...
func (Queue_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_96e4d7d76a734cd8, []int{0, 0}
}
...
type Queue struct {
	...
	RetryConfig *RetryConfig `protobuf:"bytes,3,opt,name=retry_config,json=retryConfig,proto3" json:"retry_config,omitempty"`
	...
	State Queue_State `protobuf:"varint,4,opt,name=state,proto3,enum=api.Queue_State" json:"state,omitempty"`
	...
	PurgeTime            *timestamp.Timestamp `protobuf:"bytes,5,opt,name=purge_time,json=purgeTime,proto3" json:"purge_time,omitempty"`
...
func init() {
	proto.RegisterEnum("api.Queue_State", Queue_State_name, Queue_State_value)
	proto.RegisterType((*Queue)(nil), "api.Queue")
	proto.RegisterType((*RateLimits)(nil), "api.RateLimits")
	proto.RegisterType((*RetryConfig)(nil), "api.RetryConfig")
}
...
var fileDescriptor_96e4d7d76a734cd8 = []byte{
	...
	,
}
